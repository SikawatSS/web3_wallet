...
abstract class AppLocalizations {
  ...
  /// No description provided for @tokenBalances.
  ///
  /// In en, this message translates to:
  /// **'Token Balances'**
  String get tokenBalances;
  ...
  /// No description provided for @unknownErrorDescription.
  ///
  /// In en, this message translates to:
  /// **'Something went wrong.\nPlease try again.'**
  String get unknownErrorDescription;

  /// No description provided for @unknownErrorButton.
  ///
  /// In en, this message translates to:
  /// **'OK'**
  String get unknownErrorButton;
